...
if (VERSION == "MIT"){
  ...
  samp_data = read.csv("C:/Users/Mario/Documents/Internship and REU Stuff/UNCW 2019/Atrial_Fibrillation/Data/Training_Set/all_tran_mat_2017single_2017.csv", header = T)
}
