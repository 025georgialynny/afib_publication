...
write.csv(nine_res, "/rhome/jlaws011/AFib/nine_results_1.csv")
nine_res = read.csv("/rhome/jlaws011/AFib/nine_results_1.csv", header = T)
...
c = ggplot(nine_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Sensitivity))
d = ggplot(nine_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Specificity))
...
write.csv(reg_long_res, "/rhome/jlaws011/AFib/reg_long_results_1.csv")
reg_long_res = read.csv("/rhome/jlaws011/AFib/reg_long_results_1.csv", header = T)
...
c = ggplot(reg_long_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Sensitivity))
d = ggplot(reg_long_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Specificity))
figure = ggarrange(a, b, c, d, labels = c(), ncol = 2, nrow = 2); figure

## Model 3
reg_reg_res = as.data.frame(matrix(c(methods, reg_reg_accs, reg_reg_sd, reg_reg_sens, reg_reg_spec), 4, 5, byrow = F))
colnames(reg_reg_res) = c("Method", "Accuracy", "SE", "Sensitivity", "Specificity")
write.csv(reg_reg_res, "/rhome/jlaws011/AFib/reg_reg_results_1.csv")
reg_reg_res = read.csv("/rhome/jlaws011/AFib/reg_reg_results_1.csv", header = T)
...
c = ggplot(reg_reg_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Sensitivity))
d = ggplot(reg_reg_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Specificity))
figure = ggarrange(a, b, c, d, labels = c(), ncol = 2, nrow = 2); figure
...
write.csv(pca_accs_res, "/rhome/jlaws011/AFib/pca_accs_results_1.csv")
pca_accs_res = read.csv("/rhome/jlaws011/AFib/pca_accs_results_1.csv", header = T)
...
colnames(pca_max_res) = c("Method", "Accuracy", "Dim.", "SE", "Sensitivity", "Specificity")
write.csv(pca_max_res, "/rhome/jlaws011/AFib/pca_max_results_1.csv")

pca_max_res = read.csv("/rhome/jlaws011/AFib/pca_max_results_1.csv", header = T)
...
c = ggplot(pca_max_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Sensitivity)) + 
  geom_text(aes(label=Dim., y = 0.05))
d = ggplot(pca_max_res, aes(x = Method)) + geom_bar(stat = "identity", aes(fill = Method, y = Specificity)) + 
  geom_text(aes(label=Dim., y = 0.05))
figure = ggarrange(a, b, c, d, labels = c(), ncol = 2, nrow = 2); figure
