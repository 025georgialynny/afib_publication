...
for (item in 1:length(data)){
  ...
  if (VERSION == "MIT"){
    write.csv(data[[item]], paste("/rhome/jlaws011/AFib/Data/", subjects[item], VERSION, 
...
if (VERSION == "MIT"){
  ...
  write.csv(all_data_2, paste("/rhome/jlaws011/AFib/Data/all_trans_data", VERSION, GROUP, ".csv", sep = ""))
  ...
  if (KS == "yes"){
    ...
    for (m in 1:length(data_2_pre)){
      ...
      write.csv(ks_mat, paste("/rhome/jlaws011/AFib/Data/", subjects[m], "ks.csv", sep = ""))
    }
  }
  ...
  if (VERSION == "single_2017"){
    write.csv(all_data_2, paste("/rhome/jlaws011/AFib/Data/all_tran_mat_2017", VERSION, GROUP, ".csv", sep = ""))
  }else{
    write.csv(all_data_2, paste("/rhome/jlaws011/AFib/Data/all_tran_mat_2017_multi", VERSION, GROUP, ".csv", sep = ""))
  }
}
